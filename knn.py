...
def tf_encoding_experiment(trial, train_percentage=0.1, test_percentage=0.1):
...
def tf_cifar_encoding_experiment(trial, train_percentage=0.1, test_percentage=0.1):
...
def main():
    ...
    # tf_encoding_experiment(trial, train_percentage, test_percentage)

    tf_cifar_encoding_experiment(trial, train_percentage, test_percentage)
